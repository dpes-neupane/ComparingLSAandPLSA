...
class PLSA():
    ...
    def initialize(self) -> None:
        ...
        self.prob_document_G_topic = self.__normalize(np.random.random(size= (self.n_doc, self.z_topics)))
        self.prob_words_G_topic = self.__normalize(np.random.random(size=(self.z_topics, self.w_words)))
        self.topic_prob_G_doc_w = np.zeros(shape=(self.n_doc, self.z_topics, self.w_words))
